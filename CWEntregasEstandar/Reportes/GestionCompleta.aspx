<%@ Page Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="GestionCompleta.aspx.vb"
    Inherits="Reportes_GestionCompleta" Title="CELUWEB" %>
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            ...
            <h1 class="page-header">
                <small>
                    <asp:Label ID="Label1" runat="server" Text="Gesti&#243;n Entrega"></asp:Label></small>
            </h1>
...
<%--                                        <asp:CommandField HeaderText="Fotos" SelectText="Ver Fotos" ShowSelectButton="true" />--%>
                                ...
                                <asp:SqlDataSource ID="dsDatos" runat="server" ConnectionString="<%$ ConnectionStrings:CWEntregasEstandar %>"
                                    SelectCommand="ListagestionEntregaOrbisSelProc" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
