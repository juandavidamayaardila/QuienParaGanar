<%@ Page Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="InformeFacturacion.aspx.vb" Inherits="Reportes_InformeFacturacion" Title="CELUWEB" %>
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            ...
            <h1 class="page-header">
                <small>
                    <asp:Label runat="server" Text="Informe Facturacion"></asp:Label></small>
            </h1>
                ...
                <div class="panel-body">
                    <div class="table-responsive table-scroll filtros">
                        ...
                        <asp:SqlDataSource ID="dsListaHoraInicio" runat="server" ConnectionString="<%$ ConnectionStrings:CWEntregasEstandar %>"
                            SelectCommand="FacturacionSelProc" SelectCommandType="StoredProcedure">
                            <SelectParameters>
