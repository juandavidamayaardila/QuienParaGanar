<%@ Page Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="gestionTotal.aspx.vb" Inherits="Reportes_gestionTotal" Title="CELUWEB" %>
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            ...
            <h1 class="page-header">
                <small>
                    <asp:Label ID="Label1" runat="server" Text="Gesti&#243;n Completa"></asp:Label></small>
            </h1>
                ...
                <asp:View runat="server" ID="vPrincipal">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <asp:Label ID="Label2" runat="server" Text="Lista de Viajes"></asp:Label>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive table-scroll filtros">
                                <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" DataSourceID="dsDatos"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="causalGestion" HeaderText="Causal" ReadOnly="True" SortExpression="Causal" ItemStyle-HorizontalAlign="Left" />
                                ...
                                <asp:SqlDataSource ID="dsDatos" runat="server" ConnectionString="<%$ ConnectionStrings:CWEntregasEstandar %>"
                                    SelectCommand="ListaGestionTotalOrbisSelProc" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
            ...
            <asp:Panel ID="panelResumen" runat="server" CssClass="modalPopUp">
                ...
                <div class="panel panel-default">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <asp:Label ID="Label3" runat="server" Text="Fotos"></asp:Label>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
