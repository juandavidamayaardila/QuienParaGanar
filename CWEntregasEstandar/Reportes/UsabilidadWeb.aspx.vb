...
Partial Class Reportes_UsabilidadWeb
    Inherits Culture
    ...
    Protected Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        dsDatos.SelectParameters("tipoUsuario").DefaultValue = filtros.tipoUsuario
        dsDatos.SelectParameters("usuario").DefaultValue = filtros.usuario
        dsDatos.DataBind()
