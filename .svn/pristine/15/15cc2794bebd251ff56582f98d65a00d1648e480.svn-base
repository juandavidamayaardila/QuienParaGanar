<%@ Page Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="AdminCentroDistribucion.aspx.vb"
    Inherits="Administracion_AdminCentroDistribucion" Title="CELUWEB" %>
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            ...
            <h1 class="page-header">
                <small>
                    <asp:Label runat="server" Text="Administraci&#243;n Centro de Distribuci&#243;n"></asp:Label>
                </small>
            </h1>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <asp:Label runat="server" Text="Informaci&#243;n Centro Distribuci&#243;n"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class=" table-responsive">
                        <table style="margin: auto;">
                            <tr>
                                <td>
                                    <asp:Label runat="server" Text="Centro Distribuci&#243;n"></asp:Label>:
                                </td>
                                <td>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <asp:Label runat="server" Text="Lista Centros de Distribuci&#243;n"></asp:Label>
                </div>
                <div class="table-responsive table-scroll filtros">
                    ...
                    <asp:SqlDataSource ID="dsDatos" runat="server" ConnectionString="<%$ ConnectionStrings:CWEntregasEstandar %>" SelectCommand="CediAdminSelProc"
